...
$albumid=$_SESSION['AlbumId'];
	...
	$galleryClass->deleteAlbum($albumid);
	include_once './Gellayalistgallery.php';
                  ...
                  <?php
                    if(count($listAlbum)){
                        foreach ($listAlbum as $value) {
							...
							echo "
							<td><form  method='post'>
												<input type='submit' name='select' value='Delete' > </td></tr></form>	";
					   }
                    }
                  ?>
          ...
          <table class="table table-bordered table-striped">
              ...
              <tbody>
                  <?php
                    if(count($listAlbum)){
                        foreach ($listAlbum as $value) {
                            echo "<tr><td>$value[AlbumId]</td><td>$value[ImageName]</td></tr>";
                        }
                    }
                  ?>
              </tbody>
